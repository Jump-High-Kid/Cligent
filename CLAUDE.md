...
- **베타 KPI 인프라 — Commit 3·4·5 (2026-05-04)** — 7-commit 트랙 중 **5/7 완료**. baseline **575 pass / 4 fail** (532 → 575, 회귀 0).
  ...
  - **Commit 6 (다음 세션)** = 갤러리 좋아요(D1) + 모듈별 만족도. `gallery_likes` 테이블 또는 `image_sessions.likes_json` 컬럼 선택부터.
  - 메모리: `project_beta_kpi_in_progress.md` — 5a/5b 정책·Commit 6 진입점 박힘.
